  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">在线动漫信息平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='huiyuan'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.gexingqianming" class="input" type="text" placeholder="个性签名">
			   </div>
			 </div> -->
			<el-form-item label="个性签名" class="input" v-if="tableName=='huiyuan'">
