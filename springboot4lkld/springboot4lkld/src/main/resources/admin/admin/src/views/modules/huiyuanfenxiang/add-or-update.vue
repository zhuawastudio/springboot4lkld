          ...
          <el-form-item class="input" label="邮箱" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
                placeholder="邮箱" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个性签名" prop="gexingqianming">
          <el-input v-model="ruleForm.gexingqianming" 
              placeholder="个性签名" clearable  :readonly="ro.gexingqianming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个性签名" prop="gexingqianming">
              <el-input v-model="ruleForm.gexingqianming" 
                placeholder="个性签名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.youxiang = json.youxiang
                                  		...
                                  		if(json.gexingqianming!=''&&json.gexingqianming){
              		this.ruleForm.gexingqianming = json.gexingqianming
		}
                              } else {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `huiyuanfenxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huiyuanfenxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
